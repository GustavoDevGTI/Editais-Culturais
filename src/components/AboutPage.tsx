import { ArrowLeft, CheckCircle2, Code2, Eye, ListChecks, UsersRound } from "lucide-react";
...
const principles = [
  {
    icon: Eye,
    title: "Transparência",
    text: "Informações públicas reunidas com clareza para que a população acompanhe oportunidades, prazos e resultados.",
  },
  {
    icon: ListChecks,
    title: "Organização",
    text: "Editais ativos, futuros e encerrados em um só lugar, com busca, filtros e acesso direto aos documentos oficiais.",
  },
  {
    icon: UsersRound,
    title: "Participação",
    text: "Mais proximidade com artistas, coletivos, produtores e todos que ajudam a construir a cultura de Amargosa.",
  },
];
...
const tourismTeam = [
  ...
  { label: "Participação social", name: "Conselho Municipal de Turismo" },
];
          ...
          <div className="container">
            ...
            <div className={styles.heroGrid}>
              <div>
                ...
                <h1>Informação pública para fortalecer a cultura.</h1>
              </div>
              <div className={styles.heroText}>
                ...
                <p>Em um único espaço, qualquer pessoa pode consultar oportunidades, acompanhar prazos e acessar os documentos oficiais sem depender de informações dispersas.</p>
              </div>
            </div>
